@echo off
:: ============================================
:: No Man's Sky Head Tracking - Uninstall
:: ============================================
...
:: --- CONFIG BLOCK ---
set "GAME_ID=no-mans-sky"
set "MOD_DISPLAY_NAME=No Man's Sky Head Tracking"
set "MOD_DLLS=XINPUT9_1_0.dll"
set "MOD_INTERNAL_NAME=NoMansSkyHeadTracking"
...
set "PRESERVE_FILES=Binaries\CameraUnlock.ini Binaries\HeadTracking.ini"
:: Config and log files the mod writes at runtime, removed from wherever the
:: DLLs were deployed.
set "MOD_LEFTOVERS=HeadTracking.log HeadTracking.prev.log XINPUT9_1_0_diag.txt"
